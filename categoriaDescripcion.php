...
<head>
    ...
    <title>QuibdoSolar: Descripción</title>
</head>
                            ...
                            <div class="row">
                                <div class="row g-3" >
                                    ...
                                    ?>
                                        ...
                                        <div class="col-auto">
                                            <button type="submit" name="botonAdd1" value="agregar" class="btn btn-success btn-lg" disabled>Comprar</button>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    ?>
                                        ...
                                        <div class="col-auto">
                                            <button type="submit" name="botonAdd1" value="agregar" class="btn btn-success btn-lg">Comprar</button>
                                        </div>
                                        <div class="col-auto">
                                            <a type="submit" class="btn btn-lg" style="background: #144272; color:#fff" href="./categoriaPagina.php?id=<?php echo $producto['id_categoria'] ?>" ;>Atras</a>
                                        </div>
