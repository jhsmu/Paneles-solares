...
$query = $connection->prepare("SELECT id_producto, serial, producto, cantidad, precio, estado_producto, categoria.categoria AS nombre_categoria
FROM producto
...
<head>
    ...
    <title>Quibdosolar: Productos</title>
</head>
                                        ...
                                        <div class="w-full">
                                            ...
                                            <div class="flex flex-wrap -mx-3 mb-6">
                                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                                    ...
                                                    <input class="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600" name="descripcion" id="descripcion" type="text" placeholder="Ingrese una descripción" required onchange="Descripciones2()">
                                                </div>
                                                <div class="w-full md:w-1/2 px-3">
                                                    <label class="block tracking-wide text-gray-700 text-xs font-light mb-1" for="grid-last-name">
                                                        Caracteristica
                                                    </label>
                                                    <input class="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600" name="caracteristicas" id="caracteristicas" type="text" placeholder="Ingrese las caracteristicas" required onchange="Descripciones1()">
                                                </div>
                                            </div>
                                            <div class="flex flex-wrap -mx-3 mb-6">
                                                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
