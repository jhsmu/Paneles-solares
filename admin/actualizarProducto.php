                        ...
                        <form class="w-full" action="../productos/actualizarProducto.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="flex flex-wrap -mx-3 mb-2">
                                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                                ...
                                                <input class="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-grey" type="text" name="descripcion" id="descripcion" value="<?php echo $producto['descripcion']; ?>" placeholder="<?php echo $producto['descripcion']; ?>" required onchange="Descripciones2()">
                                            </div>
                                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                                <label class="block tracking-wide text-grey-darker text-xs font-light mb-1" for="grid-city">
                                                    Caracteristicas
                                                </label>
                                                <input class="appearance-none block w-full bg-grey-200 text-grey-darker border border-grey-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-grey" type="text" name="caracteristicas" id="caracteristicas" value="<?php echo $producto['caracteristicas']; ?>" placeholder="<?php echo $producto['caracteristicas']; ?>" required onchange="Descripciones1()">
                                            </div>
                                        </div>
                                        <div class="flex flex-wrap -mx-3 mb-2">
                                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
