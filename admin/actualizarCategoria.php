...
<head>
    ...
    <title>Quibdosolar: Actualizar Categoria</title>  
</head>
        ...
        <div class="flex flex-1">
            ...
            <main class="bg-white-500 flex-1 p-3 overflow-hidden">
                ...
                <div class="mt-5">
                    ...
                    <button class='close-modal cursor-pointer bg-red-200 hover:bg-red-500 text-red-900 font-bold py-2 px-4 rounded' type="button"> <a href="./categoria.php">Volver</a>
                    </button>
                </div>
            </form>
                            </div>
