...
-- Tiempo de generación: 13-10-2023 a las 07:40:23
...
INSERT INTO `detalle_orden` (`id_detalle_orden`, `cliente`, `id_orden`, `id_producto`, `cantidad_venta`, `precio_producto`, `monto_total`, `estado`, `extra`) VALUES
(1, 1, 1, 1, 1, 990900.00, 990900.00, 0, 0),
(2, 1, 2, 16, 1, 1050990.00, 1050990.00, 0, 0),
(3, 1, 3, 6, 1, 387900.00, 387900.00, 0, 0),
(4, 1, 3, 7, 1, 1050990.00, 1050990.00, 0, 0),
(5, 1, 3, 15, 1, 1050990.00, 1050990.00, 0, 0),
(6, 1, 3, 16, 2, 1050990.00, 2101980.00, 0, 0),
(7, 1, 3, 18, 1, 1050990.00, 1050990.00, 0, 0),
(8, 1, 3, 23, 1, 1050990.00, 1050990.00, 0, 0),
(9, 1, 4, 20, 2, 1050990.00, 2101980.00, 1, 1),
(10, 1, 5, 3, 1, 715900.00, 715900.00, 1, 0),
(11, 1, 6, 1, 1, 990900.00, 990900.00, 1, 0);
...
INSERT INTO `detalle_venta` (`id_detalle_venta`, `id_venta`, `id_producto`, `cantidad_venta`, `precio_producto`, `monto_total`) VALUES
(1, 1, 1, 1, 990900.00, 990900.00),
(2, 2, 16, 1, 1050990.00, 1050990.00),
(3, 3, 6, 1, 387900.00, 387900.00),
(4, 3, 7, 1, 1050990.00, 1050990.00),
(5, 3, 15, 1, 1050990.00, 1050990.00),
(6, 3, 16, 2, 1050990.00, 2101980.00),
(7, 3, 18, 1, 1050990.00, 1050990.00),
(8, 3, 23, 1, 1050990.00, 1050990.00);
...
INSERT INTO `orden` (`id_orden`, `cliente`, `total`, `estado`, `condicion`, `fecha`) VALUES
(1, 1, 990900.00, 0, 0, '2023-10-13 04:15:04'),
(2, 1, 1050990.00, 0, 0, '2023-10-13 04:15:19'),
(3, 1, 6693840.00, 0, 0, '2023-10-13 04:48:43'),
(4, 1, 2101980.00, 1, 1, '2023-10-13 04:48:50'),
(5, 1, 715900.00, 1, 0, '2023-10-13 05:53:59'),
(6, 1, 990900.00, 1, 0, '2023-10-13 07:22:59');
...
(10, 'I123056781', 'Inversor MULTIPLUS-II 12V 3000VA Victron Energy', 'El Inversor MULTIPLUS-II 12V 3000VA de Victron Energy es una poderosa y versátil solución para la gestión de energía en sistemas autónomos y aplicaciones de energía renovable. Este inversor de onda sinusoidal pura de 3000VA y 12V es capaz de convertir la energía de la batería en electricidad de alta calidad, adecuada para alimentar una amplia variedad de dispositivos y equipos.Con su diseño avanzado y tecnología de vanguardia, el MULTIPLUS-II ofrece un rendimiento confiable y eficiente. Además de su función de inversor, también incorpora un cargador de batería con capacidad de carga adaptativa, lo que significa que puede recargar las baterías de manera óptima, maximizando su vida útil.Una de las características destacadas de este inversor es su capacidad de funcionar en modo de transferencia sin interrupción, lo que significa que puede cambiar automáticamente entre la alimentación de la red eléctrica y la energía almacenada en las baterías, garantizando un suministro de energía constante y sin cortes.', 'Control de Potencia / Asistencia Eléctrica: Permite el control de potencia y asistencia eléctrica en el sistema.Conmutador de Transferencia: Con un conmutador de transferencia de 32 A para la conmutación entre fuentes de alimentación.Entrada de CA: Rango de tensión de entrada de CA de 187-265 VCA y frecuencia de entrada de 45-65 Hz.Inversor: Ofrece una potencia continua de salida de 3000 VA o 2400 W a 25°C, 2200 W a 40°C y 1700 W a 65°C, con un pico de potencia de 5500 W.Eficiencia Máxima: Hasta un 93% de eficiencia y bajo consumo en modo de espera.Cargador: Proporciona una máxima corriente de carga de la batería de 120 A con ajustes de tensión de carga de ', 50, 800000.00, 3, 1),
...
INSERT INTO `venta` (`id_venta`, `cliente`, `total`, `fecha`) VALUES
(1, 1, 990900.00, '2023-10-13 04:15:04'),
(2, 1, 1050990.00, '2023-10-13 04:15:19'),
(3, 1, 6693840.00, '2023-10-13 04:48:43');
...
--
ALTER TABLE `detalle_orden`
  MODIFY `id_detalle_orden` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
